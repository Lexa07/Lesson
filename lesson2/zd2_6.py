...
while True:
    user = input("Хотите ввести название товра, цену и количество нажмите Enter. "
                 "Если нет, напишите нет: ")
    if user != 'нет':
        name = input("Введите название товра: ")
        price = int(input("Введите стоимость товара: "))
        units = input("Введите количество: ")
        measur = input("Введите еденицу измерения: ")
        my_dict.add((dict(название=name, цена=price, количество=units, eд=measur)))
    else:
        break
