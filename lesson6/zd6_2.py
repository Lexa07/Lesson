...
2. Реализовать класс Road (дорога), в котором определить атрибуты: length (длина), width (ширина).
    ...
    одного кв метра дороги асфальтом, толщиной в 1 см * чи сло см толщины полотна. Проверить
    работу метода.
...
class Road:
    def __init__(self, length, width):
        ...
        self._width = width
    def profit(self):
        return f"{self._length}м. X {self._width}м. Х 25кг. Х 5см. = " \
               f"{(self._length * self._width * 25 * 5) / 100} т"
